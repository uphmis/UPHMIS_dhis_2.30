...
public class OrganisationUnitLevelComparator implements Comparator<OrganisationUnit>
{
    ...
    {   
        ...
        return ( organisationUnitService.getOrganisationUnitLevel(organisationUnit1.getUid()).getLevel() - organisationUnitService.getOrganisationUnitLevel(organisationUnit0.getUid()).getLevel() );
    }
}
