...
{
	var url = "showedAssociationsDataSetAssignEditor.action";
...
{
	var url = "definedAssociationDataSetAssignEditor.action?";
...
{
	var url = "definedMultiAssociationsDataSetAssignEditor.action?";
